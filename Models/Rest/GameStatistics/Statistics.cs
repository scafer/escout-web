...
{
    [JsonProperty("gameStats")] public List<GameStat> GameStats { get; set; }

    [JsonProperty("totalStats")] public List<TotalStat> TotalStats { get; set; }
}
...
public class TotalStat
{
    ...
    [JsonProperty("standardDeviation")] public double StandardDeviation { get; set; }
