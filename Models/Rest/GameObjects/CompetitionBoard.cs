...
public class CompetitionBoard
{
    ...
    [JsonProperty("goalsFor")] public int GoalsFor { get; set; }

    [JsonProperty("goalsAgainst")] public int GoalsAgainst { get; set; }

    [JsonProperty("goalsDifference")] public int GoalsDifference { get; set; }
