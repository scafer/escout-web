...
public class Athlete
{
    ...
    [Required] [JsonProperty("height")] public double Height { get; set; }

    [Required] [JsonProperty("weight")] public double Weight { get; set; }

    [Required] [JsonProperty("position")] public string Position { get; set; }
    ...
    [JsonProperty("currentInternational")] public string CurrentInternational { get; set; }
